...
(:~
 ...
 : </pre>
 : File available at http://bazaar.launchpad.net/~zorba-coders/zorba/xqdoc-module/view/head:/modules/html.xq
 :
        ...
        if(exists($schemas)) then
          <section>
            ...
            <ul>
            {
              ...
              let $href := "/html/xqdoc-html/schemas/" || replace(replace($uri, "http://", ""), "/", "_") || ".html" 
              return <li>
                <a href="{$href}">{$uri}</a>
              </li>
            }
